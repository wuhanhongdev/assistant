INSERT INTO assistant.t_org (id, fullname, shortname, pid, code, address_detail, phone, manager_id, detail, status) VALUES (1, '系统机构', '系统机构', -1, '0000', '', '', null, null, 1);
INSERT INTO assistant.t_org (id, fullname, shortname, pid, code, address_detail, phone, manager_id, detail, status) VALUES (2, '钱场镇党委', '钱场镇', 1, '123123', '1231231111', '123123', null, '<html><head><style type="text/css">.view{padding:0;word-wrap:break-word;cursor:text;height:90%;}body{margin:8px;font-family:sans-serif;font-size:16px;}p{margin:5px 0;}</style><link rel="stylesheet" type="text/css" href="http://localhost:8999/assistant/ueditor/themes/iframe.css"><style id="tablesort">table.sortEnabled tr.firstRow th,table.sortEnabled tr.firstRow td{padding-right:20px;background-repeat: no-repeat;background-position: center right;   background-image:url(http://localhost:8999/assistant/ueditor/themes/default/images/sortable.png);}</style><style id="table">.selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:1px solid #BBB;background-color:#F7F7F7;}table tr.firstRow th{border-top-width:2px;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}</style><style id="list">ol,ul{margin:0;pading:0;width:95%}li{clear:both;}li.list-cn-1-0{background-image:url(http://bs.baidu.com/listicon/list-cn-1-0.gif)}
...
.list-paddingleft-3{padding-left:60px}</style><style id="pagebreak">.pagebreak{display:block;clear:both !important;cursor:default !important;width: 100% !important;margin:0;}</style><style id="pre">pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;}</style><style id="loading">.loadingclass{display:inline-block;cursor:default;background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/loading.gif'') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}
.loaderrorclass{display:inline-block;cursor:default;background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/loaderror.png'') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id="anchor">.anchorclass{background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/anchor.gif'') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style><style type="text/css">body{background-color:#ffffff; background-image:; background-repeat:repeat; background-position:0% 0%; height:500px; }</style> </head><body ><ol class=" list-paddingleft-2" style="list-style-type: decimal;"><li><p>1</p></li><li><p>1</p></li><li><p>1</p></li><li><p>1</p></li><li><p>1<br/></p></li></ol><p><img src="http://localhost:8999/assistant/6de791de470d4901a55fbceb0851b455.jpg" title="6de791de470d4901a55fbceb0851b455.jpg" alt="6de791de470d4901a55fbceb0851b455.jpg" width="215" height="138"/></p><p><br/></p></body></html>', 1);
INSERT INTO assistant.t_org (id, fullname, shortname, pid, code, address_detail, phone, manager_id, detail, status) VALUES (3, '政府机关支部', '政府机关支部', 1, 'qwe', 'qwe', 'qwe12345678', null, '<html><head><style type="text/css">.view{padding:0;word-wrap:break-word;cursor:text;height:90%;}body{margin:8px;font-family:sans-serif;font-size:16px;}p{margin:5px 0;}</style><link rel="stylesheet" type="text/css" href="http://localhost:8999/assistant/ueditor/themes/iframe.css"><style id="tablesort">table.sortEnabled tr.firstRow th,table.sortEnabled tr.firstRow td{padding-right:20px;background-repeat: no-repeat;background-position: center right;   background-image:url(http://localhost:8999/assistant/ueditor/themes/default/images/sortable.png);}</style><style id="table">.selectTdClass{background-color:#edf5fa !important}table.noBorderTable td,table.noBorderTable th,table.noBorderTable caption{border:1px dashed #ddd !important}table{margin-bottom:10px;border-collapse:collapse;display:table;}td,th{padding: 5px 10px;border: 1px solid #DDD;}caption{border:1px dashed #DDD;border-bottom:0;padding:3px;text-align:center;}th{border-top:1px solid #BBB;background-color:#F7F7F7;}table tr.firstRow th{border-top-width:2px;}.ue-table-interlace-color-single{ background-color: #fcfcfc; } .ue-table-interlace-color-double{ background-color: #f7faff; }td p{margin:0;padding:0;}</style><style id="list">ol,ul{margin:0;pading:0;width:95%}li{clear:both;}li.list-cn-1-0{background-image:url(http://bs.baidu.com/listicon/list-cn-1-0.gif)}
li.list-cn-1-1{background-image:url(http://bs.baidu.com/listicon/list-cn-1-1.gif)}
li.list-cn-1-2{background-image:url(http://bs.baidu.com/listicon/list-cn-1-2.gif)}
li.list-cn-1-3{background-image:url(http://bs.baidu.com/listicon/list-cn-1-3.gif)}
li.list-cn-1-4{background-image:url(http://bs.baidu.com/listicon/list-cn-1-4.gif)}
...
.list-paddingleft-2{padding-left:30px}
.list-paddingleft-3{padding-left:60px}</style><style id="pagebreak">.pagebreak{display:block;clear:both !important;cursor:default !important;width: 100% !important;margin:0;}</style><style id="pre">pre{margin:.5em 0;padding:.4em .6em;border-radius:8px;background:#f8f8f8;}</style><style id="loading">.loadingclass{display:inline-block;cursor:default;background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/loading.gif'') no-repeat center center transparent;border:1px solid #cccccc;margin-left:1px;height: 22px;width: 22px;}
.loaderrorclass{display:inline-block;cursor:default;background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/loaderror.png'') no-repeat center center transparent;border:1px solid #cccccc;margin-right:1px;height: 22px;width: 22px;}</style><style id="anchor">.anchorclass{background: url(''http://localhost:8999/assistant/ueditor/themes/default/images/anchor.gif'') no-repeat scroll left center transparent;cursor: auto;display: inline-block;height: 16px;width: 15px;}</style><style type="text/css">body{background-color:#ffffff; background-image:; background-repeat:repeat; background-position:0% 0%; height:500px; }</style> </head><body ><ol class=" list-paddingleft-2" style="list-style-type: decimal;"><li><p>123sddaxz</p></li><li><p>asdasdas</p></li><li><p>sdadaa</p></li><li><p>dasdasd</p></li><li><p>112113<br/></p></li></ol></body></html>', 1);
INSERT INTO assistant.t_org (id, fullname, shortname, pid, code, address_detail, phone, manager_id, detail, status) VALUES (4, '休干支部', '休干支部', 1, 'aa111', 'aaaa1222', 'aa111', null, null, 1);